...
public class Financing {
    ...
    public Financing(Integer financingId,Integer companyId,Double financingMoney,Integer saleId,Integer repertoryId,java.util.Date financingTime,String financingType) {
        super();
